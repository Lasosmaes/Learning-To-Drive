...
#include "MyObstacleSpawnController.generated.h"

UCLASS()
class LEARNTODRIVEGAME_API AMyObstacleSpawnController : public AActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AMyObstacleSpawnController();
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, Category = "Obstacle")
		TSubclassOf<AMyObstacle> obstacle;
